  ...
  return (
    <div className="flex relative flex-col-reverse items-center lg:flex-row  lg:justify-between overflow-hidden mt-[56px] md:mt-[80px] lg:mt-0">
      ...
      <div className="lg:hidden -mt-[6vw]">
        ...
        <button className="mx-auto bg-orange text-white flex  px-[4vw] py-[2vw] md:px-[3vw] md:py-[1vw] items-center text-[3vw] md:text-[2vw] rounded-xl cursor-pointer mt-8  border border-orange hover:text-orange hover:bg-white duration-300">
          <p>Know more</p>
      ...
      <Wrapper className="absolute top-44  left-0 right-0 lg:block hidden">
        ...
        <button className="bg-orange text-white flex gap-2 px-[1.5vw] py-[0.8vw] items-center text-[1vw] rounded-xl cursor-pointer mt-8  border border-orange hover:text-orange hover:bg-white duration-300">
          <p>Know more</p>
