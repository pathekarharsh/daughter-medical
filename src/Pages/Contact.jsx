      ...
      <Wrapper className="py-8 md:py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-gray text-lg mt-6 max-w-3xl mx-auto">
            Have questions about our products or services? Reach out to our team for expert advice and support.
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8 md:gap-12">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray">Indravati Apartment, M. B. Estate, Near Aakar Nagar<br />Katol Road, Nagpur - 440013</p>
                </div>
              </div>
            </div>

            <div className="mt-8">
              <h3 className="text-lg font-medium text-dark mb-4">Business Hours</h3>
              <div className="space-y-2">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-dark font-medium">10:00 AM - 4:00 PM</span>
                </div>
                <div className="flex justify-between">
          ...
          <div className="lg:w-1/2 bg-white rounded-3xl shadow-md p-8 md:p-12">
            <h2 className="text-2xl md:text-3xl font-bold text-dark mb-6">
              Send Us a Message
            </h2>
